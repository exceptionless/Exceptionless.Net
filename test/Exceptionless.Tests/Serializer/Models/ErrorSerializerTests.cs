...
namespace Exceptionless.Tests.Serializer.Models {
    public class ErrorSerializerTests : SerializerTestBase {
        ...
        /* lang=json */
        private const string ExtraPropertiesJson = """{"modules":[],"message":"Test error message","type":"System.Exception","code":"1001","data":{"@ext":{"OrderNumber":10}},"inner":null,"stack_trace":[],"target_method":null}""";
        /* lang=json */
